...
const getAllDeadlines = () => {
  ...
  taskListsContainer.forEach(tasklist => {
    tasklist.content.forEach(task => {
      if (!(0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.deadline), today) && task.deadline !== '' ||
      (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.deadline) === today) {

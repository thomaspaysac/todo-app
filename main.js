...
const getDeadlines = (() => {
  ...
  const getDay = () => {
    ...
    (0,_dom_create_js__WEBPACK_IMPORTED_MODULE_1__.loadFiltersDetails)('Next 24 hours', deadlineToday);

...
// Generate display of each task
  (tasklist.content).forEach(task => {
    ...
    if (task.deadline === '') {
      ...
      single_task_deadline.textContent = task.deadline + ' | ' + (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(task.deadline)) + ' ago';
    } else {
      single_task_deadline.textContent = task.deadline + ' | ' + (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(task.deadline)) + ' left';
    }
...
TEST_BUTTON.addEventListener('click', () => {
    ...
    //const comparison = 
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(date), new Date())) {
      console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(date)) + ' ago');
    } else {
    console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(date)) + ' left');
    }
});
})();
